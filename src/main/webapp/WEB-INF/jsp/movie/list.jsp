		...
		<c:when test="${!empty movies}">
			<div class="col-md-12">
				...
				<div class="pull-right">
					<form class="form-inline" name="filterByGenreForm" method='get' action="../movie/list">
				...
				<div class="pull-left">
					<form class="form-inline" name="filterByDirectorForm" method='get' action="../movie/list">
