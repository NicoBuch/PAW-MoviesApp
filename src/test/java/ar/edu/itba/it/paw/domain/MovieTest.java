...
public class MovieTest {
	...
	public void emptyTitleTest() {
		...
		new Movie("", new Date(System.currentTimeMillis()), "director", genres, 15, "description");
	}
	...
	public void emptyDirectorTest() {
		Set<Genre> genres = new HashSet<Genre>();
		genres.add(new Genre("andy"));
		new Movie("title", new Date(System.currentTimeMillis()), "", genres, 15, "caca");
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void emptyGenresTest() {
		Set<Genre> genres = new HashSet<Genre>();
		new Movie("title", new Date(System.currentTimeMillis()), "director", genres, 15, "caca");
	}
	...
	public void emptyDescriptionTest() {
		Set<Genre> genres = new HashSet<Genre>();
		genres.add(new Genre("andy"));
		new Movie("title", new Date(System.currentTimeMillis()), "director", genres, 15, "");
	}
	...
	public void titleTooLongTest() {
		...
		new Movie(a, new Date(System.currentTimeMillis()), "director", genres, 15, "caca");
	}
	...
	public void directorTooLongTest() {
		...
		genres.add(new Genre("andy"));
		String a = "";
		new Movie("title", new Date(System.currentTimeMillis()), a, genres, 15, "caca");
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void nullGenresTest() {
		new Movie("title", new Date(System.currentTimeMillis()), "director", null, 15, "caca");
	}
	...
	public void isNewTest(){
		Set<Genre> genres = new HashSet<Genre>();
		genres.add(new Genre("andy"));
		Movie movie = new Movie("title", new Date(System.currentTimeMillis()), "director", genres, 15, "caca");
	...
	public void alReadyReleasedtTest(){
		Set<Genre> genres = new HashSet<Genre>();
		genres.add(new Genre("andy"));
		Movie movie = new Movie("title", new Date(System.currentTimeMillis() - 10000), "director", genres, 15, "caca");
	...
	public void setGenresTest(){
		...
		Assert.assertTrue(movie.getGenres().contains(genre2) && !movie.getGenres().contains(genre3));
		genres.remove(genre2);
		genres.add(genre3);
		Assert.assertTrue(movie.getGenres().contains(genre3) && !movie.getGenres().contains(genre2));
	}	
